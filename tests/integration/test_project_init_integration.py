...
class TestProjectInitIntegration:
    ...
    def test_full_project_initialization_python(
        ...
        try:
            ...
            pre_commit_calls = [call for call in mock_subprocess.call_args_list 
...
""")
        ...
        try:
            ...
            if (project_path / "README.md").exists():
                ...
                assert "Custom template for test-custom-template-project" in readme_content
    ...
    def test_project_initialization_with_contributing_features(
        ...
        try:
            ...
            assert (project_path / ".github" / "ISSUE_TEMPLATE" / "bug_report.md").exists()
            assert (project_path / ".github" / "ISSUE_TEMPLATE" / "feature_request.md").exists()
    ...
    def test_project_initialization_with_ci_cd(
        ...
        try:
            ...
            ci_workflow = (project_path / ".github" / "workflows" / "ci.yml").read_text()
