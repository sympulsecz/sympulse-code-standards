...
class ProjectGenerator:
    ...
    def create_project(self, path: Union[str, Path], language: str, 
                      template: Optional[str] = None, force: bool = False) -> bool:
    ...
    def _init_git_repo(self, path: Path):
        ...
        try:
            ...
            subprocess.run(["git", "commit", "-m", "Initial commit with coding standards"], 
                         cwd=path, check=True)
                    ...
                    if template_dir.is_dir():
                        try:
                            ...
                            templates.append({
                                ...
                                "path": str(template_dir.relative_to(self.templates_path))
                            })
                        except Exception as e:
